...
class TestLinearClassifiers(unittest.TestCase):
    ...
    def test_native_linuxstandalone(self):
        ...
        materializer = LinuxRemote(implementation, measure_accuracy=True, measure_time=True, measure_perf=False, hostname="kiefer", remote_compile=True, ssh_config=None)
