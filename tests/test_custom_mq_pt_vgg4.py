...
# Load config
config = load_test_config('config_vgg4_mq842.yaml')
...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='config_vgg4_mq842.yaml', help='Path to config file')
...
if __name__ == "__main__":
    ...
    if args.config != 'config_vgg4_mq842.yaml':
